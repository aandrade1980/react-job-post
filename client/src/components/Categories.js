...
function Categories() {
  ...
  return (
    <div style={{ margin: 50 }}>
      ...
      {errMessage && (
        <span style={{ display: "block", color: "rgb(179, 15, 15)" }}>
          <i className="fas fa-exclamation-circle" /> {errMessage}
        </span>
      )}
            ...
            return (
              <li style={{ marginTop: 5 }} key={category._id}>
                ...
                <i
                  ...
                  style={{ color: "#b30f0f", cursor: "pointer", marginLeft: 5 }}
                  onClick={() => removeCategory(category._id)}
                  onKeyDown={() => removeCategory(category._id)}
                  role="button"
                  tabIndex="0"
                />
              </li>
